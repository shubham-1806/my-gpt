                                ...
                                <Typewriter
                                    ...
                                    onInit={typewriter => {
                                        typewriter
                                            ...
                                            .typeString(
                                                message.length > 10 &&
                                                    botMessageList[Number(id)].length < 10
                                                    ? message
                                                    : botMessageList[Number(id)],
                                            )
                                            .start();
