    ...
    useEffect(() => {
        ...
        setChats([
            ...
            },
            {
                ...
                " " +
                "Social workers are trained to be action-oriented in achieving change in society to assist vulnerable populations. They are able to witness firsthand the areas of strength and weakness within the caring system." +
                "\n" +
